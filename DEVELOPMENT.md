...
```bash
git remote add encore encore://donation-platform-wdt2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/donation-platform-wdt2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/donation-platform-wdt2/settings/integrations/github)
