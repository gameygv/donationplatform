          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">Exclusive Documents</h3>
                  <p className="text-sm text-muted-foreground">
                    Access premium PDF documents and research materials
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Watch exclusive educational videos and tutorials
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  <p className="text-muted-foreground mb-4">
                    Please register or login to make a donation
                  </p>
